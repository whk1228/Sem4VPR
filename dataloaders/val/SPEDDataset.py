...
DATASET_ROOT = '/root/autodl-tmp/SPEDTEST/'
GT_ROOT = '/root/autodl-tmp/salad/datasets/'  # BECAREFUL, this is the ground truth that comes with GSV-Cities
# autodl-tmp/salad/datasets/Nordland/Nordland_dbImages.npy
